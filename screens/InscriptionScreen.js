...
/*
  The registration page consists of three text fields for email, 
  username and password, and a button to send the information.
*/
...
InscriptionScreen.navigationOptions = {
  header: null,
};
